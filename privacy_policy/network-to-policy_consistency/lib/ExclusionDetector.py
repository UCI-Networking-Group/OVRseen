...
def isPrepPhraseWord(token):
    return token.lemma_ in ['except when', 'except where', 'unless when', 'unless where', 'except for', 'except in', 'except under', 'unless for', 'unless in', 'unless under', 'apart from', 'aside from', 'with the exception of', 'other than', 'except to', 'unless to', 'unless as', 'except as']
...
#   dumpTree(sentence.root)
    for tok in sentence:
        ...
        elif tok.lemma_ in ['except for', 'exclude', 'except in', 'except under', 'unless for', 'unless in', 'unless under', 'apart from', 'aside from', 'with the exception of', 'besides', 'beside', 'other than', 'except', 'except to', 'unless to', 'without'] or (tok.lemma_ in ['include'] and isNegated(tok)):
