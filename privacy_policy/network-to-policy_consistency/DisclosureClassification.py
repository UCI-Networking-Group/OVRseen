...
policySentencesDf.to_csv(output_dir / "PolicySentences_w_shouldIgnore.csv", sep=',', encoding='utf-8', index=False)
...
def writeCsvRow(csvfile, packageName, flowEntity, flowData, policyEntity, policyAction, policyData, policySentences, consistencyResult, entityVagueness, entityVaguenessRaw, dataVagueness, dataVaguenessRaw, contradictionNum, contradictoryEntity, contradictoryAction, contradictoryData, contradictionSentences):
    csvfile.writerow((packageName, flowEntity, flowData, policyEntity, policyAction, policyData, policySentences if policySentences is not None else None, consistencyResult, entityVagueness, entityVaguenessRaw, dataVagueness, dataVaguenessRaw, contradictionNum, contradictoryEntity, contradictoryAction, contradictoryData, contradictionSentences if contradictionSentences is not None else None))
...
outputfile = open(DATA_ROOT / 'policheck_results.csv', 'w')
